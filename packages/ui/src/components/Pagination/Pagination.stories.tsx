...
const meta = {
  ...
  argTypes: {
    ...
    onChange: {
      description:
        "Callback chamado quando a pessoa usuária seleciona uma página.",
      control: false,
      table: {
        category: "EVENTS",
  ...
  parameters: {
    docs: {
      ...
      source: {
        code: '<Pagination count={10} color="primary" size="medium" />',
      },
    },
  },
...
export const Playground: Story = {
  parameters: {
    docs: {
      ...
      description: {
        story:
          "Explore as propriedades de quantidade, cor e tamanho no painel de controles.",
      },
    },
  },
};
...
export const Colors: Story = {
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <Pagination
        count={5}
        color="secondary"
        aria-label="Paginação secundária"
      />
  ...
  parameters: {
    ...
    docs: {
      canvas: { sourceState: "shown" },
      description: { story: "Cores disponíveis para a navegação." },
    },
  },
};
...
export const Sizes: Story = {
  ...
  parameters: {
    ...
    docs: {
      canvas: { sourceState: "shown" },
      description: { story: "Tamanhos disponíveis para a navegação." },
    },
  },
};
